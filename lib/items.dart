    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: TabBar(
            ...
            tabs: <Widget>[
              Tab(child:Text("#-#- IP Calc -#-#",style:
              GoogleFonts.robotoMono(fontSize: 15, fontWeight: FontWeight.bold),
              )),
              Tab(child:Text("#-#- Subnet -#-#",style:
              GoogleFonts.robotoMono(fontSize: 15, fontWeight: FontWeight.bold),
              )),
            ]
        ),
    ...
    return new Container(
        ...
        child: TextField(
          ...
          decoration: const InputDecoration(
            isDense: true,
            hintText: '192.168.0.1/24', counterText: "",
