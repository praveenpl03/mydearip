...
class Address {
  ...
  Address(String addressStr) {
    ...
    int val = 4294967296;
    this.address = int.parse(splitted[0]) * 256 * 256 * 256 + int.parse(splitted[1]) * 256 * 256 + int.parse(splitted[2]) * 256 + int.parse(splitted2[0]);
    num x =pow(2, 32 - int.parse(splitted2[1]));
    this.prefix = val - x.toInt();
    this.prefixNum = int.parse(splitted2[1]);
  }
